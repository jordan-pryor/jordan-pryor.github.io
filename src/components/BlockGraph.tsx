...
// Color palette
const colors = {
    noActivity: "#282a36", // Background
    lowActivity: "#50fa7b", // Green
    mediumActivity: "#ff79c6", // Pink
    highActivity: "#ff5555", // Red
    veryHighActivity: "#f1fa8c" // Yellow
};
...
const BlockGraph = () => {
    ...
    onMount(() => {
        ...
        const svg = d3
            ...
            .attr("width", width)
            .attr("height", height)
            .style("background-color", "#282a36"); // Background
            ...
            .then(events => {
                ...
                svg.append("g")
                    ...
                    .on("mouseover", function() {
                        d3.select(this).style("fill", "#ff79c6"); // Highlight color
                    })
